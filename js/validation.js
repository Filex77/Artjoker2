$(document).ready(function (e) {
    ...
    function validateForm() {
        ...
        let v_select3 = false;
        if ($("#sel_ter :selected").val() == "") {
            v_select3 = true;
            $('#sel_ter_chosen').after('<span class="text-error">Выберите опцию</span>');
        };
        // Проверка ФИО    
        let el_l = $("#username");
        ...
        return (v_login || v_email || v_select1 || v_select2 || v_select3);
    }
}
);